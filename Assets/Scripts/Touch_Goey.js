...
function OnGUI () {
	if (guiEnabled){
		...
		GUI.Label (Rect(screenwidth - 175, screenhieght - 50, 200, 30), "           3D model by");
		GUI.Label (Rect(screenwidth - 130, screenhieght - 30, 200, 30), "PHCoModels");
		
		GUI.Label (Rect(15, screenhieght - 60, 500, 30), "Hit M to mute audio, H to hide user interface");
		GUI.Label (Rect(20, screenhieght - 40, 500, 30), "Hit Escape to quit");
